...
{
    public class TinheadSpearProjectile : ModProjectile
    {
        public int Length => TextureAssets.Projectile[Type].Value.Height;
        public int tipDist => TextureAssets.Projectile[Type].Value.Height + 8;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tinhead Spear"); // The English name of the projectile
        ...
        public override void AI()
        {
            ...
            float tipDist = Length + extension * extendDist - retraction * retractDist; // If your Jousting Lance is larger or smaller than the standard size, it is recommended to change the shoot speed of the item instead of this value.
            ...
            if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f)
            {
                ...
                int dustTypeCommon = DustID.Smoke;
                int dustTypeRare = DustID.SteampunkSteam;
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            float scaleFactor = Length; // How far back the hit-line will be from the tip of the Jousting Lance. You will need to modify this if you have a longer or shorter Jousting Lance. Vanilla uses 95f
