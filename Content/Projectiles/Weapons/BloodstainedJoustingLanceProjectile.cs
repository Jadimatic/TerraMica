...
{
	public class BloodstainedJoustingLanceProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Bloodstained Lance"); // The English name of the projectile
		...
		public override void AI() {
			...
			if (playerVelocity > minimumDustVelocity && movementInLanceDirection > 0.8f) {
				...
				int dustTypeCommon = DustID.CrimsonTorch;
				int dustTypeRare = DustID.Blood;
