...
{
	public class CopperheadSpear : ModItem
	{
		...
		public override void SetDefaults() 
		{
			...
			Item.DefaultToSpear(ModContent.ProjectileType<Projectiles.Weapons.CopperheadSpearProjectile>(), 1f, 24);
	...
	/*public class CopperheadSpearPlayer : ModPlayer
	{
		public override void Hurt(bool pvp, bool quiet, double damage, int hitDirection, bool crit, int cooldownCounter)
		{
			int itemType = ModContent.ItemType<CopperheadSpear>(); // Change this to your item
