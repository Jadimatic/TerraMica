...
namespace TerraMica.Content.Items.Armor
{
	...
	public class BambooHelmet : ModItem
	{
		...
		{
			return body.type == ModContent.ItemType<BambooBreastplate>() && legs.type == ModContent.ItemType<BambooLeggings>();
		}

		// UpdateArmorSet allows you to give set bonuses to the armor.
		public override void UpdateArmorSet(Player player) 
		{
			player.setBonus = "Reduces damage taken by 8%\nPiercing attacks have a chance to poison enemies"; // This is the setbonus tooltip
