...
namespace TerraMica.Content.NPCs
{
    public enum WormSegmentType
    {
        ...
        Body,
        /// <summary>
        /// The alternative body segment.  Follows the segment in front of it
        /// </summary>
        BodyAlt,
        /// <summary>
    ...
    public abstract class WormHead : Worm
    {
        ...
        /// <summary>
        /// The NPCID or ModContent.NPCType for the alternative body segment NPCs.<br/>
        /// This property is only used if <see cref="HasCustomBodySegments"/> returns <see langword="false"/>.
        /// </summary>
        public abstract int BodyTypeAlt { get; }
        ...
        /// </summary>
        public virtual bool HasCustomBodySegments => true;
            ...
            if (Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                if (!hasFollower)
                {
                    ...
                    for (int i = 0; i < Main.maxNPCs; i++)
                    {
                        ...
                        if (n.active && (n.type == Type || n.type == BodyType || n.type == BodyTypeAlt || n.type == TailType) && n.realLife == NPC.whoAmI)
                            count++;
                    }
    ...
    public abstract class WormBodyAlt : Worm
    {
        public sealed override WormSegmentType SegmentType => WormSegmentType.BodyAlt;
